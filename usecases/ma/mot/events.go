...
// handle SPINE events
func (e *MOT) HandleEvent(payload spineapi.EventPayload) {
...
func (e *MOT) deviceConnected(entity spineapi.EntityRemoteInterface) {
...
func (e *MOT) deviceMeasurementDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if measurement, err := client.NewMeasurement(e.LocalEntity, entity); err == nil {
...
func (e *MOT) deviceMeasurementDataUpdate(payload spineapi.EventPayload) {
	if measurement, err := client.NewMeasurement(e.LocalEntity, payload.Entity); err == nil {
		...
		if measurement.CheckEventPayloadDataForFilter(payload.Data, filter) && e.EventCB != nil {
			e.EventCB(payload.Ski, payload.Device, payload.Entity, DataUpdateOutdoorTemperature)
		}
	}
}
